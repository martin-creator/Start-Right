use crate::ai_macros::ai_react_frontend::{
    print_react_svg_logo,
    print_react_completed_logo_with_brand_name_react_component,
    print_react_header_navigation_react_component,
  ...
  impl BuildComponent {
    ...
    async fn create_and_save(&self, msg_context: String,  ai_function: fn(&str) -> &'static str) {
      ...
      // Save Component
      save_react_frontend_code(&self.filepath(), &ai_response);
    }
  
    /// Prepare and create component
    pub async fn create_component(&self, agent: &AgentReactFrontendDeveloper, project_description: &String) {
      ...
      match self {
        ...
        Self::Logo => {
          ...
          let ai_response_svg_logo: String = ai_task_request(
            msg_context, 
            "Component Writer", 
            get_function_string!(print_react_svg_logo), 
            print_react_svg_logo).await;
        ...
        Self::NavHeader | Self::NavFooter => {
          ...
          if self.name() == "NavHeader" {
            self.create_and_save(
              msg_context,
              print_react_header_navigation_react_component).await;
          } else {
            self.create_and_save(
              msg_context,
              print_react_footer_navigation_react_component).await;
          }
        },
        ...
        Self::PageContent1 | Self::PageContent2 => {
          ...
          dbg!(&file_path);
          let react_hook_contents: String = read_react_frontend_code_contents(&file_path);
          ...
          let wireframe_content: String = ai_task_request(
            ...
            get_function_string!(print_react_html_webpage_content_with_text), 
            print_react_html_webpage_content_with_text).await;
